...
## Dimension reduction {.transition .center}
...
## Bring your own data {.transition .center}

## Your turn

- Examine data of your own choice
- Share what you learn about your data, [here](https://forms.gle/jeJPGPjjE3CzTvUu7)

::: {.f70}

If you don't have your own data, try looking at the [risk_MSA](https://github.com/dicook/mulgar_book/blob/master/data/risk_MSA.rds) which contains survey responses on six types of risks (recreational, health, career, financial, safety and social) perceived with Australian tourism, collected in 2015, used in [Dolnicar et al, 2018](https://link.springer.com/chapter/10.1007/978-981-10-8818-6_2). 
